...
CV_PDFFILES := $(PAGES_CV_DIR)/takzhanov-cv-en.pdf $(PAGES_CV_DIR)/takzhanov-cv-ru.pdf
...
$(PAGES_CV_DIR)/takzhanov-cv-en.pdf: $(CV_DIR)/cv-en.tex $(CV_DIR)/template.tex $(CV_DIR)/content/en.tex | $(CV_BUILD_DIR) $(PAGES_CV_DIR)
...
$(PAGES_CV_DIR)/takzhanov-cv-ru.pdf: $(CV_DIR)/cv-ru.tex $(CV_DIR)/template.tex $(CV_DIR)/content/ru.tex | $(CV_BUILD_DIR) $(PAGES_CV_DIR)
